...
void AFirstPersonCharacter::BeginPlay()
{
	...
	if (GunBlueprint == NULL) { 
		UE_LOG(LogTemp, Warning, TEXT("Gun is missing GunBlueprint"));
		return; 
	}
	...
	if (EnableTouchscreenMovement(playerComponent) == false)
	{
		playerComponent->BindAction("Fire", IE_Pressed, Gun, &AGun::OnFire);
	}
